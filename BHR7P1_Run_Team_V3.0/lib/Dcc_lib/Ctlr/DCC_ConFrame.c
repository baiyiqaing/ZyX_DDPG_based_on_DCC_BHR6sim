...
void fnvAddConVal(int nKpre) { // modify the trajactories
	...
	Tra_COM.x[nKpre] = stStateCmd.Base.pos.x;
	Tra_COM.y[nKpre] = stStateCmd.Base.pos.y;
	Tra_COM.z[nKpre] = stStateCmd.Base.pos.z;
	pitch_body = stStateCmd.Base.rot.pit;
	roll_body  = stStateCmd.Base.rot.rol;
	Tra_RAnkle.x[nKpre] = stStateCmd.Ankle.W.Rfoot.pos.x;
	Tra_RAnkle.y[nKpre] = stStateCmd.Ankle.W.Rfoot.pos.y;
	Tra_RAnkle.z[nKpre] = stStateCmd.Ankle.W.Rfoot.pos.z;
	pitch_footr = stStateCmd.Ankle.W.Rfoot.rot.pit;
	roll_footr = stStateCmd.Ankle.W.Rfoot.rot.rol;
	Tra_LAnkle.x[nKpre] = stStateCmd.Ankle.W.Lfoot.pos.x;
	Tra_LAnkle.y[nKpre] = stStateCmd.Ankle.W.Lfoot.pos.y;
	Tra_LAnkle.z[nKpre] = stStateCmd.Ankle.W.Lfoot.pos.z;
