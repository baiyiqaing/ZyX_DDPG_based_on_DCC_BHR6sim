...
namespace mav_system_msgs
{
  ...
  class CpuInfo : public ros::Msg
  {
    ...
    CpuInfo():
      header(),
      cpu_percent_length(0), cpu_percent(NULL),
      heaviest_processes_length(0), heaviest_processes(NULL)
    {
    }
    ...
    const char * getType(){ return "mav_system_msgs/CpuInfo"; };
    const char * getMD5(){ return "d955ed6c182adaafbfa41e78710954d2"; };
