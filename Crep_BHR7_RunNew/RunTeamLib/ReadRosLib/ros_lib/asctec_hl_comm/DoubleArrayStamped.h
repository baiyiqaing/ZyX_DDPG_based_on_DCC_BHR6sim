#ifndef _ROS_asctec_hl_comm_DoubleArrayStamped_h
#define _ROS_asctec_hl_comm_DoubleArrayStamped_h
...
namespace asctec_hl_comm
{
  ...
  class DoubleArrayStamped : public ros::Msg
  {
    ...
    const char * getType(){ return "asctec_hl_comm/DoubleArrayStamped"; };
