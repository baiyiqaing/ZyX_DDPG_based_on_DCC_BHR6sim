...
typedef struct {
	dccZMP ZMP;  //  ZMP
	dccSpacial Base; // 髋的基座-上身
	dccFootFT FootFT;//两只脚的力合力矩
	dccAnkleTwoFrame Ankle;//两个踝的位置和姿态
	int SupLeg; // dou 0, rsup 1, lsup 2, fly 3---提前规划好  的  支撑信号
}dccRobotState;
